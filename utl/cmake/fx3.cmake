...
#   FX3_ARMGCC_INSTALL_PATH - to locate compilator installation
...
file(TO_CMAKE_PATH $ENV{FX3_ARMGCC_INSTALL_PATH} FX3_ARMGCC_INSTALL_PATH)
message(STATUS "FX3_ARMGCC_INSTALL_PATH: ${FX3_ARMGCC_INSTALL_PATH}")
...
set(CMAKE_EXE_SIZE ${TOOLCHAIN_PREFIX}size)
...
if (WIN32)
    ...
    set(CMAKE_EXE_ELF2IMG  "${FX3_INSTALL_PATH}/util/elf2img/elf2img")
endif()

message(STATUS ${CMAKE_EXE_ELF2IMG})
...
# Standard C library
set(FX3_C_LIBS
  "${FX3_ARMGCC_INSTALL_PATH}/arm-none-eabi/lib/libm.a"
  "${FX3_ARMGCC_INSTALL_PATH}/arm-none-eabi/lib/libc.a"
  "${FX3_ARMGCC_INSTALL_PATH}/lib/gcc/arm-none-eabi/$ENV{FX3_ARMGCC_VERSION}/libgcc.a"
  )

# STD C++ Library
set(FX3_CXX_LIBS
  "${FX3_ARMGCC_INSTALL_PATH}/arm-none-eabi/lib/libstdc++.a"
  "${FX3_ARMGCC_INSTALL_PATH}/lib/gcc/arm-none-eabi/$ENV{FX3_ARMGCC_VERSION}/libgcc.a"
  )
...
function(add_img_generator target)
    ...
    add_custom_command(
        ...
        COMMAND ${CMAKE_EXE_ELF2IMG} -i ${location} -o ${name}.img -vectorload yes
...
function(fx3_add_target target)
  ...
  target_link_options(${target} PRIVATE --print-memory-usage)
